...
int main(){
    ...
    if (first == NULL) 
        return(1);
    stack_node *second = malloc(sizeof(stack_node));
    if (second == NULL) 
        return(1);
    stack_node *third = malloc(sizeof(stack_node));
    if (third == NULL) 
        return(1);
    stack_node *a = first;
    ...
    stack_node *fourth = malloc(sizeof(stack_node));
    if (fourth == NULL) 
        return(1);
    stack_node *fifth = malloc(sizeof(stack_node));
    if (fifth == NULL) 
        return(1);
    stack_node *sixth = malloc(sizeof(stack_node));
    if (sixth == NULL) 
        return(1);
    stack_node *b = fourth;
